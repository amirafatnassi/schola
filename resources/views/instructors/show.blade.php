        ...
        <div class="container">
            <div class="row g-5">
                    ...
                    <div class="position-relative h-100">
                        <div class="team-item bg-light">
                            <div class="overflow-hidden">
                                <img class="img-fluid" style="width: 450px; height: 450px; object-fit: cover;" src="{{ asset('storage/' . $instructor->avatar) }}" alt="">
                            </div>
                            ...
                            <div class="text-center p-4">
                                <div class="star-rating">
                                    @for ($i = 1; $i <= 5; $i++)
                                        <span class="fa fa-star {{ $instructor->rating >= $i ? 'text-warning' : 'text-muted' }}"></span>
                                        @endfor
                                        ({{$instructor->rating}})
                                </div>
                            </div>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">{{$instructor->role}}</h6>
