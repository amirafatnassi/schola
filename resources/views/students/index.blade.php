                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{ asset('storage/' . $student->avatar) }}" alt="" style="width: 350px; height: 150px; object-fit: cover;">
                        </div>
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0"><a href="{{url('students/'.$student->id)}}">{{$student->name}}</a></h5>
                            <small>{{$student->email}}</small>
                            <div class="">
                                 <a href="{{route('students.show', $student->id)}}" class="flex-shrink-0 btn btn-sm btn-primary" style="border-radius: 30px;">Visit profile</a>
                            </div>
                        </div>
                    </div>
                </div>
